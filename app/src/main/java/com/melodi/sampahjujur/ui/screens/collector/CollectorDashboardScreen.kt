...
fun CollectorDashboardScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Person 4: Kabadiwala Connect - Formal Recycling Quick Actions
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Text(
                                text = "Formal Recycling Supply Chain",
                                fontSize = 11.sp,
                                color = MediumGray
                            )
                        }
                        Button(
                            onClick = { onNavigate("create_collection_request") },
                            ...
                            Text("New Lot", fontWeight = FontWeight.Bold, fontSize = 13.sp)
                        }
                    }
                    ...
                    Row(
                        ...
                        OutlinedButton(
                            onClick = { onNavigate("earnings_ledger") },
                            modifier = Modifier.weight(1f),
                            shape = RoundedCornerShape(10.dp),
                            contentPadding = PaddingValues(vertical = 4.dp)
                        ) {
                            Icon(Icons.Default.AccountBalanceWallet, contentDescription = null, tint = PrimaryGreen, modifier = Modifier.size(15.dp))
                        ...
                        OutlinedButton(
                            ...
                            Icon(Icons.Default.History, contentDescription = null, tint = PrimaryGreen, modifier = Modifier.size(15.dp))
                            Spacer(modifier = Modifier.width(3.dp))
                        ...
                        OutlinedButton(
                            ...
                            Icon(Icons.Default.PrecisionManufacturing, contentDescription = null, tint = PrimaryGreenDark, modifier = Modifier.size(15.dp))
                            Spacer(modifier = Modifier.width(3.dp))
